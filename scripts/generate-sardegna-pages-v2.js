...
function buildSitemap(hubs, municipalities) {
  ...
  const urls = [
    ...
    { loc: `${SERVICE.baseUrl}/lavaggio-tappeti-a-domicilio-sardegna/`, priority: '0.95' },
    { loc: `${SERVICE.baseUrl}/lavaggio-tappeti-a-domicilio-cagliari/`, priority: '0.85' },
    { loc: `${SERVICE.baseUrl}/lavaggio-tappeti-a-domicilio-sud-sardegna/`, priority: '0.85' },
